    ...
    try {
      ...
      if (wallet.connected && candyMachine?.program && wallet.publicKey) {
        ...
        if (!status?.err) {
          setAlertState({
            open: true,
            message: 'Congratulations, You Planted A Seed!',
            severity: 'success',
          });
        } else {
          setAlertState({
            open: true,
            message: 'Planting failed, Water the Dirt & try again!',
            severity: 'error',
          });
        }
      }
      ...
      // TODO: blech:
      let message = error.msg || 'Planting failed, Water the Dirt & try again!';
      if (!error.msg) {
        if (!error.message) {
